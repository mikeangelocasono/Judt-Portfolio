  ...
  return (
    <section id="contact" className="section-padding">
      <div className="container mx-auto px-6 lg:px-12">
        <div className={cn(
          "rounded-[2.5rem] p-6 md:p-10 relative overflow-hidden",
          "flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-10 max-w-6xl mx-auto",
          ...
          <Reveal delay={0.15} className={cn(
            "lg:w-5/12 p-5 md:p-6 rounded-[2rem] border relative z-10 w-full max-w-md mx-auto lg:mx-0",
